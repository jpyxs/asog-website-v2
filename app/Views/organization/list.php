    ...
    <div class="max-w-[1100px] mx-auto relative z-[2]">
        ...
        <div class="reveal-group max-w-[980px] mx-auto flex flex-col items-center gap-6 md:gap-8">
            <div class="rc text-center w-full max-w-[280px] mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 w-full justify-items-center">
                <div class="rc text-center w-full max-w-[280px] mx-auto">
                    <div class="mx-auto aspect-square rounded-lg mb-3 p-[2px]"
                        style="width:220px;max-width:100%;background:linear-gradient(160deg, rgba(3,85,140,.58), rgba(3,85,140,.2));">
                        <div class="w-full h-full rounded-[7px] overflow-hidden">
                ...
                <div class="rc text-center w-full max-w-[280px] mx-auto">
                    <div class="mx-auto aspect-square rounded-lg mb-3 p-[2px]"
                        ...
                        <div class="w-full h-full rounded-[7px] flex items-center justify-center"
                            style="background:linear-gradient(to top, rgba(3,85,140,.30), rgba(3,85,140,.10));">
                            <div class="w-full h-full rounded-[7px] overflow-hidden">
                                <img src="<?= base_url('assets/img/team/Gavino.png') ?>" alt="Mr. Kevin B. Capoles"
                                    class="w-full h-full object-cover object-center" />
                            </div>
                        </div>
                    </div>
                    <h4 class="font-display text-[1.05rem] font-semibold text-dark leading-tight">Mr. Kevin B. Capoles
                    </h4>
                    <span class="text-[.6rem] font-semibold tracking-[.1em] uppercase text-dark mt-1 block">Team
                        Member</span>
...
<section id="tbi-staff" class="relative bg-white py-12 md:py-16 px-6 md:px-10 lg:px-14">
    ...
    <div class="max-w-[1100px] mx-auto relative z-[2]">
        ...
        <div class="flex flex-col items-center gap-6 md:gap-8 reveal-group max-w-[800px] mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-5 w-full max-w-[640px] justify-items-center">
...
<section id="interns" class="relative bg-off py-12 md:py-16 px-6 md:px-10 lg:px-14">
    ...
    <div class="max-w-[1100px] mx-auto relative z-[2]">
        ...
        <div
            class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 w-full max-w-[1020px] mx-auto justify-items-center reveal-group">
                ...
                <span class="text-[.62rem] font-semibold tracking-[.1em] uppercase text-sky mt-1.5 block">Intern</span>
            </div>
...
<section id="mentors" class="relative bg-off py-12 md:py-16 px-6 md:px-10 lg:px-14">
    ...
    <div class="max-w-[1100px] mx-auto relative z-[2]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 reveal-group justify-items-center">
