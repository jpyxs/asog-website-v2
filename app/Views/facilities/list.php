...
<section id="co-lab" class="scroll-mt-28 bg-off">
    <div class="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 min-h-[420px] facility-row">
        ...
        <div class="flex flex-col justify-center px-8 md:px-14 lg:px-20 py-12 lg:py-14 facility-copy">
            ...
            <p class="text-[.92rem] font-normal leading-[1.85] text-black mb-6">Modern coworking space where teams
...
<section id="innovators-suite" class="scroll-mt-28 bg-off">
    <div class="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 min-h-[420px] facility-row">
        <div
            ...
            <p class="text-[.92rem] font-normal leading-[1.85] text-black mb-6">Dedicated offices for early-stage
        ...
        <div class="bg-off h-[320px] md:h-[360px] lg:h-[420px] relative overflow-hidden facility-carousel aircode-carousel"
            ...
            <div class="facility-carousel-dots" data-carousel-dots>
                <button type="button" class="facility-carousel-dot is-active" aria-label="AIRCoDe photo 1"
                    data-carousel-dot="0"></button>
                <button type="button" class="facility-carousel-dot" aria-label="AIRCoDe photo 2"
                    data-carousel-dot="1"></button>
                <button type="button" class="facility-carousel-dot" aria-label="AIRCoDe photo 3"
                    data-carousel-dot="2"></button>
            </div>
        </div>
        <div class="flex flex-col justify-center px-8 md:px-14 lg:px-20 py-12 lg:py-14 facility-copy">
...
<section id="fablab" class="scroll-mt-28 bg-off">
    <div class="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 min-h-[420px] facility-row">
        ...
        <div class="bg-off h-[320px] md:h-[360px] lg:h-[420px] relative overflow-hidden order-1 lg:order-2 facility-carousel"
            ...
            <div class="facility-carousel-dots" data-carousel-dots>
                <button type="button" class="facility-carousel-dot is-active" aria-label="FabLab photo 1"
                    data-carousel-dot="0"></button>
                <button type="button" class="facility-carousel-dot" aria-label="FabLab photo 2"
                    data-carousel-dot="1"></button>
                <button type="button" class="facility-carousel-dot" aria-label="FabLab photo 3"
                    data-carousel-dot="2"></button>
            </div>
        </div>
    </div>
...
<section id="ssf" class="scroll-mt-28 bg-off">
    <div class="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 min-h-[420px] facility-row">
        <div class="bg-off h-[320px] md:h-[360px] lg:h-[420px] relative overflow-hidden facility-carousel"
            ...
            <div class="facility-carousel-dots" data-carousel-dots>
                <button type="button" class="facility-carousel-dot is-active" aria-label="SSF photo 1"
                    data-carousel-dot="0"></button>
                <button type="button" class="facility-carousel-dot" aria-label="SSF photo 2"
                    data-carousel-dot="1"></button>
                <button type="button" class="facility-carousel-dot" aria-label="SSF photo 3"
                    data-carousel-dot="2"></button>
            </div>
        </div>
        <div class="flex flex-col justify-center px-8 md:px-14 lg:px-20 py-12 lg:py-14 facility-copy">
...
<section id="ip-unit" class="scroll-mt-28 bg-off">
    <div class="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 min-h-[420px] facility-row">
        <div
            ...
            <p class="text-[.92rem] font-normal leading-[1.85] text-black mb-6">Specialized office for intellectual
        ...
        <div class="bg-off h-[320px] md:h-[360px] lg:h-[420px] relative overflow-hidden order-1 lg:order-2 facility-carousel"
            ...
            <div class="facility-carousel-dots" data-carousel-dots>
                <button type="button" class="facility-carousel-dot is-active" aria-label="IPMD photo 1"
                    data-carousel-dot="0"></button>
                <button type="button" class="facility-carousel-dot" aria-label="IPMD photo 2"
                    data-carousel-dot="1"></button>
            </div>
        </div>
    </div>
