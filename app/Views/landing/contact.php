    ...
    <div class="max-w-[1400px] mx-auto relative z-[2]">
        ...
        <div class="text-center mb-10 md:mb-14 reveal">
            ...
            <h2 class="font-display text-3xl md:text-[2.4rem] leading-[1.12] text-dark">
                Contact &amp; <em class="italic text-gold">Location</em>
            </h2>
        </div>
            ...
            <div class="reveal">
                ...
                <div class="relative rounded-lg overflow-hidden mb-5" style="height:420px;">
                    ...
                    <!-- <div class="absolute bottom-4 left-4 right-4 md:right-auto md:max-w-[320px] z-10 bg-gold rounded-lg p-4 md:p-5 shadow-lg">
                        <h3 class="font-display text-[1rem] md:text-[1.1rem] text-white leading-tight mb-3">ASOG Technology Business Incubator</h3>
                        <div class="flex items-center gap-2">
                            <svg class="w-3.5 h-3.5 text-black shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                            </svg>
                            <a href="mailto:<?= esc($contactEmail) ?>" class="text-[.78rem] text-black font-medium no-underline hover:text-black transition-colors"><?= esc($contactEmail) ?></a>
                        </div>
                    </div> -->
                </div>
                ...
                <div class="flex items-center gap-1">
                    ...
                    <a href="<?= esc($fbUrl) ?>" target="_blank" rel="noopener" title="Facebook"
                        class="inline-flex items-center justify-center w-9 h-9 no-underline transition-all duration-200 hover:text-[#1877F2] hover:-translate-y-0.5"
                    ...
                    <a href="<?= esc($igUrl) ?>" target="_blank" rel="noopener" title="Instagram"
                        class="inline-flex items-center justify-center w-9 h-9 no-underline transition-all duration-200 hover:text-[#E4405F] hover:-translate-y-0.5"
                        style="color:rgba(2,13,24,.4)">
                        <svg class="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="<?= esc($xUrl) ?>" target="_blank" rel="noopener" title="X"
                        class="inline-flex items-center justify-center w-9 h-9 no-underline transition-all duration-200 hover:text-black hover:-translate-y-0.5"
                        style="color:rgba(2,13,24,.4)">
                        <svg class="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="<?= esc($threadsUrl) ?>" target="_blank" rel="noopener" title="Threads"
                        class="inline-flex items-center justify-center w-9 h-9 no-underline transition-all duration-200 hover:text-[#101010] hover:-translate-y-0.5"
                        style="color:rgba(2,13,24,.4)">
                        <svg class="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
                            <path
