...
$roleLabel = ucwords(str_replace('_', ' ', (string) ($role ?? 'admin')));
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <tr>
                                    <td style="padding:24px">
                                        <p style="margin:0 0 18px;font-size:15px;line-height:1.75;color:#334155">
                                            Hi <strong style="color:#082F49"><?= esc($adminName ?? 'there') ?></strong>, an ASOG TBI account has been created for you with <strong style="color:#082F49"><?= esc($roleLabel) ?></strong> access.
                                        </p>
                                        <p style="margin:0 0 22px;font-size:14px;color:#526577;line-height:1.7">
                                            Set your own password before signing in. This secure link expires in <strong style="color:#213142">24 hours</strong>.
                                        </p>

                                        <table cellpadding="0" cellspacing="0" role="presentation" style="margin:0 0 22px">
                                            <tr>
                                                <td style="background:#03558C;border-radius:4px">
                                                    <a href="<?= esc($setupUrl) ?>" style="display:inline-block;padding:13px 20px;color:#FFFFFF;text-decoration:none;font-size:12px;font-weight:800;letter-spacing:.12em;text-transform:uppercase">
                                                        Set Password
                                                    </a>
                                                </td>
                                            </tr>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background:#F8F6F2;border:1px solid #E4DED2;border-radius:7px;margin-bottom:16px">
                                            <tr>
                                                <td style="padding:16px 18px">
                                                    <p style="margin:0 0 8px;font-size:10px;font-weight:800;letter-spacing:.13em;text-transform:uppercase;color:#03558C">
                                                        Google Sign-In
                                                    </p>
                                                    <p style="margin:0;font-size:13px;color:#526577;line-height:1.65">
                                                        If Google sign-in is enabled, you may also sign in with the Google account that uses this same email address.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
